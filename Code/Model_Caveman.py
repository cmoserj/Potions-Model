# Connected Caveman Model
# Script written by Cody Moser
# This script runs the Potions Task on Connected Caveman Networks
...
class NetworkModel(Model):
    ...
    def __init__(self, cliques=26, cliqueK=1, change_link=0, prob_diff = 100,ranked = 0, postcross= 0):
        ...
        self.change_link = 1 - (change_link/100) #Probability of partner change
        self.prob_diff = 1 - (prob_diff/100) #Probability of diffusion to each neighbor
        self.num_agents = self.cliques * self.cliqueK #Determine number of agents

        #Create the network of l cliques of size k
        ...
        self.datacollector = DataCollector(
            model_reporters={"CliqueSize": lambda m:m.cliqueK,
